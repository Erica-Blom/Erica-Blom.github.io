...
styleUserInput.textContent = `
  ...
  .input-container{padding:16px !important; border-bottom-right-radius:0px !important;position:fixed !important; bottom:0px;right:0px;width:${innerWidth}px !important};
`
