window.addEventListener('DOMContentLoaded', () => {
  ...
  chatbubbleStyle.textContent = `
    ...
    .chat-wrapper.expanded{bottom:0px !important; animation: .25s ease forwards slideInFromRight; border-top-right-radius:0px !important;transform:none; transition:none }
