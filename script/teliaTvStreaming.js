...
console.log("med timeout10")
  ...
  feedbackThumbsStyle.textContent = `
    ...
    .feedback .textarea-row:before{content:"Övrig feedback"; line-height:20px; font-weight:500; margin-bottom:0.25rem; outline: none;}
    ...
    .feedback .feedback-box .feedback-title{color:#FFFFFF !important; font-size:0px !important}
    ...
    .feedback .feedback-box .feedback-submit:before{content:"Skicka feedback"; color:#FFFFFF !important; font-size:16px;}
  ...
  handoverButtonStyle.textContent = `
    ...
    #dfButtonAnchorWrapper:hover{background-color:#F5E0FF;border:#4E0174 solid 1px !important}
    #dfButtonAnchorWrapper:active{background-color:#E4B6FB;border:#29003E solid 1px !important}
    #dfButtonAnchorWrapper .text.word-wrap{font-weight:500 !important;padding-left:16px !important}
    #dfButtonAnchorWrapper:hover .text.word-wrap{opacity:1 !important; color:#4E0174 !important}
    #dfButtonAnchorWrapper:active .text.word-wrap{opacity:1 !important; color:#29003E !important}
    ...
    #dfButtonAnchorWrapper:hover .df-button-icon{opacity:1 !important}
